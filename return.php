...
<!--               <button type="button">Check Availability!</button>-->
                <form action="return_end.php" method="post">
                  ...
                  <fieldset>
                     ...
                     <label for="ret_date">Date of Return:</label>
                     <input type="text" id="name" name="ret_date">
                  ...
                  <fieldset><button type="submit">Return</button></fieldset>
               </form>
