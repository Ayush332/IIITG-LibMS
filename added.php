   	...
   	<div class="row">
	   	...
	   	<nav id="main-nav-wrap">
				<ul class="main-navigation">
					...
					<li><a class="smoothscroll"  href="#process" title="">Add Member</a></li>
   	...
   	<div class="row process-content">
   		...
   		<div class="left-side">
   			...
   			<div class="item" data-item="1">
	   			...
	   			<p>In this a admin can add a member and issue that on their respective id's or roll no.</p>
...
$statement = $conn->prepare("INSERT INTO `members` (`Username`,`name`,`mob_no`,`sem`)
    VALUES(?, ?, ?,?)");
//$fine=0;

$statement->execute(array($uid,$nam,$mobile,$sem)) or die(print_r($statement->error_info(), true));
