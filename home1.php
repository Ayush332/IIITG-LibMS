...
<body id="top">
   ...
   <section id="process">  
   	...
   	<div><div>
   				...
   				<center><h5>Add Members</h5>

   				<p>Account Creation By Admin for Library related Issues and Uses</p>
   				<form action="addmem.php">
               <input type="submit" value="Add Member" /></center>
               </form> 	
   			</div></div>
   		...
   		<div class="right-side">
   			<div class="item" data-item="2">
	   			...
	   			<center><h5>Add Books</h5>

	   			<p>Adding Books by Admin for Library Studying Purposes.</p>
               <form action="addbook.php">
               <input type="submit" value="Add Book" />
               </form></center>
               <center><h5>Return</h5>

	   			<p> All can return book through this feature.</p>
   ...
   <section id="testimonials">
   	...
   	<div class="row">
   		<div class="col-twelve">
   			<h2 class="h01">Hear What Are Team Leaders Say.</h2>
   		</div>   		
   	</div>   	
               ...
               <li>
               	<div class="testimonial-author">
                    	...
                    	<div class="author-info">
                    		Ayush Srivastav
                    		<span class="position">Enthusiast and Future Leader.</span>
                    	</div>
                  </div>
