   	...
   	<div class="row">
	   	...
	   	<nav id="main-nav-wrap">
				<ul class="main-navigation">
					...
					<li><a class="smoothscroll"  href="#process" title="">Add Book</a></li>
   	...
   	<div class="row process-content">
   		...
   		<div class="left-side">
   			...
   			<div class="item" data-item="1">
	   			...
	   			<p>In this a admin can add a book  and issue that on their respective id's or roll no.</p>
<!--               <button type="button">Check Availability!</button>-->
            <!--    <form action="index.html" method="post">
                  ...
                  <fieldset>
                     ...
                     <input type="text" id="name" name="sem">
                 ...
                 <!-- <fieldset>
                  ...
                  <fieldset><button type="submit">Add Member</button></fieldset>
               </form>-->
...
$statement = $conn->prepare("INSERT INTO `books` (`book_id`,`book_name`,`subject_code`,`rack`,`copies`,`issued`)
    VALUES(?, ?, ?,?,?,?)");
//$fine=0;

$statement->execute(array($bid,$nam,$code,$rack,"1","F")) or die(print_r($statement->error_info(), true));
