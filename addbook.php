   	...
   	<div class="row process-content">
   		...
   		<div class="left-side">
   			...
   			<div class="item" data-item="1">
	   			...
	   			<p>In this a admin can add a book and member and issue that on their respective id's or roll no.</p>
<!--               <button type="button">Check Availability!</button>-->
                <form action="addedbook.php" method="post">
                  ...
                  <fieldset>
                     ...
                     <input type="text" id="name" name="rack">
                  ...
                  <fieldset><button type="submit">Add Book</button></fieldset>
               </form>
