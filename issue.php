   	...
   	<div class="row">
	   	...
	   	<nav id="main-nav-wrap">
				<ul class="main-navigation">
					...
					<li><a class="smoothscroll"  href="#process" title="">Issue</a></li>
...
$book_nameid=$_POST['Book_name'];
$code=$_POST['code'];
$sql1 = " Select copies from books where book_name='$book_nameid' And subject_code= '$code' ";
$sql2 = " Select count(book_id) from books where issued='T' AND book_name='$book_nameid'";
$sql3 = " Select book_id from books where issued='F' AND book_name='$book_nameid' ";
...
<!--               <button type="button">Check Availability!</button>-->
                <form action="issue_end.php" method="post">
      
                  <h1>ISSUE</h1>
                  <fieldset>
                     <label for="id">Book Id:</label>
               <input type="text" id="nam" name="id">
